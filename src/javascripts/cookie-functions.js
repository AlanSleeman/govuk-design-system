...
export function resetCookies () {
  ...
  if (!options || options.version !== CONSENT_COOKIE_VERSION) {
...
function userAllowsCookie (cookieName) {
  ...
  if (COOKIE_CATEGORIES[cookieName]) {
    ...
    // If no preferences or old version use the default
    if (!cookiePreferences || cookiePreferences.version !== CONSENT_COOKIE_VERSION) {
      var cookiePreferences = DEFAULT_COOKIE_CONSENT
    }
